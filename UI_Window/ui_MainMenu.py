...
"")
        ...
        self.verticalLayout_9.setContentsMargins(6, 6, 6, 20)
...
"")
        ...
        sizePolicy3.setHeightForWidth(self.a_2.sizePolicy().hasHeightForWidth())
        self.a_2.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.dashboard_btn_2.sizePolicy().hasHeightForWidth())
        self.dashboard_btn_2.setSizePolicy(sizePolicy4)
        font = QFont()
        ...
        sizePolicy3.setHeightForWidth(self.d_2.sizePolicy().hasHeightForWidth())
        self.d_2.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.parental_btn_2.sizePolicy().hasHeightForWidth())
        self.parental_btn_2.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.settings_btn_2.sizePolicy().hasHeightForWidth())
        self.settings_btn_2.setSizePolicy(sizePolicy4)
        ...
        self.verticalLayout_11.addWidget(self.frame1, 0, Qt.AlignHCenter)
        ...
        sizePolicy5.setHeightForWidth(self.cont_stackedwidget.sizePolicy().hasHeightForWidth())
        self.cont_stackedwidget.setSizePolicy(sizePolicy5)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.use_time_btn.sizePolicy().hasHeightForWidth())
        self.use_time_btn.setSizePolicy(sizePolicy6)
...
"")
        ...
        sizePolicy7.setHeightForWidth(self.start_box.sizePolicy().hasHeightForWidth())
        self.start_box.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.background_box.sizePolicy().hasHeightForWidth())
        self.background_box.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.app_time_track_box.sizePolicy().hasHeightForWidth())
        self.app_time_track_box.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.theme_box.sizePolicy().hasHeightForWidth())
        self.theme_box.setSizePolicy(sizePolicy7)
        ...
        sizePolicy6.setHeightForWidth(self.notify_box.sizePolicy().hasHeightForWidth())
        self.notify_box.setSizePolicy(sizePolicy6)
        ...
        sizePolicy1.setHeightForWidth(self.alert_lbl.sizePolicy().hasHeightForWidth())
        self.alert_lbl.setSizePolicy(sizePolicy1)
        ...
        sizePolicy7.setHeightForWidth(self.alert_box.sizePolicy().hasHeightForWidth())
        self.alert_box.setSizePolicy(sizePolicy7)
        ...
        sizePolicy1.setHeightForWidth(self.camera_lbl.sizePolicy().hasHeightForWidth())
        self.camera_lbl.setSizePolicy(sizePolicy1)
        ...
        sizePolicy7.setHeightForWidth(self.camera_box.sizePolicy().hasHeightForWidth())
        self.camera_box.setSizePolicy(sizePolicy7)
...
"")
        ...
        sizePolicy6.setHeightForWidth(self.username_line.sizePolicy().hasHeightForWidth())
        self.username_line.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.old_PIN_line.sizePolicy().hasHeightForWidth())
        self.old_PIN_line.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.new_PIN_line.sizePolicy().hasHeightForWidth())
        self.new_PIN_line.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.confirm_PIN_line.sizePolicy().hasHeightForWidth())
        self.confirm_PIN_line.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.change_PIN_btn.sizePolicy().hasHeightForWidth())
        self.change_PIN_btn.setSizePolicy(sizePolicy7)
