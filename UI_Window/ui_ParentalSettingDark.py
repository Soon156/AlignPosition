...
################################################################################
## Form generated from reading UI file 'ParentalSettingDark.ui'
##
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.monitor_setting_box.setToolTip(QCoreApplication.translate("Dialog", u"<html><head/><body><p>Automatically start detection when application is opened</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.monitor_setting_box.setText(QCoreApplication.translate("Dialog", u"Monitor", None))
#if QT_CONFIG(tooltip)
        self.method_box.setToolTip(QCoreApplication.translate("Dialog", u"<html><head/><body><p>Switch to able/disable posture detection</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
